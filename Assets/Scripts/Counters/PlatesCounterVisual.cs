...
public class PlatesCounterVisual : MonoBehaviour
{
    ...
    private void PlatesCounter_OnPlateSpawned(object sender, System.EventArgs e)
    {
        ...
        plateSpawnedTransform.localPosition = new Vector3(0, plateOffsetY * plateVisualGameObjectList.Count, 0);

        plateVisualGameObjectList.Add(plateSpawnedTransform.gameObject);
    }
}
